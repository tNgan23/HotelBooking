...
<head>
    ...
    <title>Hotel Booking - CONFIRM BOOKING</title>
...
<body class="bg-light">
    ...
    */
            ...
            if (checkin_val != '' && checkout_val != '') {
                ...
                xhr.onload = function () {
                    ...
                    if (data.status == 'check_in_out_equal') {
                        pay_info.innerText = "You cannot check_out on the same day!";
                    }
                        ...
                        paypal.Buttons({
                            // Thêm các tùy chọn thanh toán của bạn ở đây
    ...
    <script
        src="https://www.paypal.com/sdk/js?client-id=AU3g2DuSRfnmlRNKZLB2OIxw6o45I-PyLmBPOGIIk0as8tEaPtto2lh2sRPLNDgWjZi_SWWcmd72Y0g6&currency=USD"></script>
    <script>
        paypal.Buttons({
