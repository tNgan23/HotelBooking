<div class="container-fluid bg-white mt-5">
  <div class="row">
    ...
    <div class="col-lg-4 p-4 ">
      ...
      if ($contact_r['ytb'] != '') {
        echo <<<data
                <a href="$contact_r[ytb]" class="d-inline-block text-dark text-decoration-none mb-2">
  ...
  register_form.addEventListener('submit', (e) => {
    ...
    xhr.onload = function () {
      if (this.responseText == 'pass_mismatch') {
        ...
        alert('error', "Cannot send comfirmation email! Server down!");
      }else if (this.responseText == 'ins_failed') {
        alert('error', "Registration failed ! Server down!");
      }else{
        alert('success',"Registration successful. Comfirmation link send to email!");
        register_form.reset();
      }
    }
    xhr.send(data);
  ...
  forgot_form.addEventListener('submit', (e) => {
    ...
    xhr.onload = function () {
      if (this.responseText == 'inv_email') {
        ...
        alert('error', "Email is already verified! Please contact Admin ");
      } 
      else if (this.responseText == 'inactive') {
        alert('error', "Account Suspended! Please contact Admin. ");
      } 
